...
CREATE TABLE `userblock` (
  ...
  PRIMARY KEY (`block_id`,`blocker_id`,`blocked_id`),
  KEY `fk_USERBLOCK_USER1_idx` (`blocker_id`),
  KEY `fk_USERBLOCK_USER2_idx` (`blocked_id`),
  CONSTRAINT `fk_USERBLOCK_USER1` FOREIGN KEY (`blocker_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `fk_USERBLOCK_USER2` FOREIGN KEY (`blocked_id`) REFERENCES `user` (`user_id`)
